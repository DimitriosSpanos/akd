...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', num_classes=10, co_sponge=4, channel_t=None):
        ...
        if channel_t is not None:
            ...
            ch = num_filters[3]
        self.layer31 = conv_1x1_bn(num_filters[3], ch*co_sponge)
        self.layer32 = conv_1x1_bn(ch*co_sponge, num_filters[3])
...
if __name__ == '__main__':
    ...
    net = resnet8x4_student(num_classes=20)
